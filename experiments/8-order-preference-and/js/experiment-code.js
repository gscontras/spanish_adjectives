...
function make_slides(f) {
  ...
  slides.multi_slider = slide({
    ...
    present_handle : function(stim) {
      ...
      this.modification = _.sample([" "," and "])

      if (this.modification==" ") {
        this.mod_type = "hierarchical"
      } else {
        this.mod_type = "parallel"
      };
      ...
      $(".low").html("\"the "+ stim.Predicate2 + this.modification + stim.Predicate1 + " " + stim.Noun + "\"");

      $(".high").html("\"the "+ stim.Predicate1 + this.modification + stim.Predicate2 + " " + stim.Noun + "\"");
